...
class CM_Widget_Closest_Rep extends WP_Widget
{

    public function __construct()
    {
        $widget_ops = array(
            'classname' => 'wpcm_closest_rep'
            ,'description' => __( 'Shows the user their closest rep')
        );

        parent::__construct('wpcm_closest_rep', __('Closest Rep'), $widget_ops);
    }
    ...
    public function widget($args, $instance)
    {
        ...
        wpcm_template( 'widget-closest-rep', array('title' => $title, 'action' => get_permalink( $page )) );
    }
}
