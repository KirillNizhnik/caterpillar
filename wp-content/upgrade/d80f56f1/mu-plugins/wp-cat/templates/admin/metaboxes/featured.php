...
global $post, $wpdb;
$fields = get_post_meta( $post->ID, 'featured_details', true );
?>
    ...
    <li>
        <div class="field-row">
            ...
            <div class="field-label col-9">
                <input class="widefat" name="post_meta[featured_details][<?php echo $label; ?>]" type="text" value="<?php echo $value; ?>" />
            </div>
        </div>
...
<script type="text/template" class="fieldTemplate">
    ...
    <li>
        <div class="field-row">
            ...
            <div class="field-label col-9">
                <input class="widefat" name="post_meta[featured_details][<%= label %>]" type="text" value="" />
            </div>
        </div>
