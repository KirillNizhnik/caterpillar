...
class DSF_Product
{
    ...
    public function save()
    {
        ...
        $post['post_title']  =  ucwords(strtolower(trim($this->year.' '.$this->manufacturer->name)).' '.$this->model);
        $post['post_type']   = 'cat_used_machine';
        ...
        if( $post_id = wp_insert_post($post) ) {
            ...
            wp_set_object_terms($post_id, (int)$this->manufacturer->term_id, 'cat_used_machine_manufacturer' );
