<?php 
/*
* All new machine terms dropdown
*/ 
?>


                                        <div class="filter-search-category-select just-new-dropdown just-new-dropdown" hidden>

                            <select name="categ" id="categ-new" class="just-new-dropdown" >
