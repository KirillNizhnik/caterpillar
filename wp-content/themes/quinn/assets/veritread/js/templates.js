var VTTemplates = (function (pId) {
    ...
    var initializeTemplates = function() {
        ...
        if (partnerSettings.useCol2) {
            ...
            if (partnerSettings.useVideo) {
                videoLink = '<p class="vt-header2 vt-video-container"><a class="btn btn-link" href="' + DEFAULT_VIDEO_URL + '" target="_blank">How It Works</a></p>';
            }
    ...
    [   '          <div class="vt-results">',
        ...
        '                    <img src="{{assetsDir}}/img/veritread-logo2.png" alt="VeriTread" class="vt-logo" /> Estimate',
        '                </div>',
    ...
    [
      '<div class="vt-get-estimate"><button class="btn btn-primary vt-get-estimate-button">Get Estimate</button></div>'
    ];
    ...
    templates.Header =
    [  '<div class="vtbranding vt-header-1"><a href="http://www.veritread.com/" target="_blank"><img src="{{assetsDir}}/img/veritread-logo1.png" alt="VeriTread" class="vt-logo" /></a> Shipping Estimator</div>'
    ];

    templates.HeaderDetailed =
    [  '<div class="vtbranding vt-header-2"><a href="http://www.veritread.com/" target="_blank">Get Accurate Freight Quotes &amp; Qualified Bids Using <img src="{{assetsDir}}/img/veritread-logo2.png" alt="VeriTread" class="vt-logo" /></a></div>'
    ];
    ...
    [   '<div class="vt-col2" style="display:none;">',
        ...
        '    <h4>Why Get Bids with VeriTread?</h4>',
        '    <ul><li><strong>Save Money</strong>',
        '    <ul><li>Get multiple competitive bids.</li></li></ul>',
        '    <li><strong>Industry Leading Transportation Providers</strong>',
        '    <ul><li>Read feedback &amp; view never before seen details.</li></li></ul>',
        '    <li><strong>It Is Fast &amp; Easy</strong>',
        '    <ul><li>List your shipment for free.</li></li></ul></ul>',
        '    {{videoLink}}',
        '    <p class="">',
        '      <a href="http://www.veritread.com/" class="btn btn-block btn-primary" target="_blank">Learn More at VeriTread.com</a>',
        '    </p>',
        '  </section>',
        '  <section class="vt-errorMsg vt-alert vt-alert-error vt-hide">',
    ...
    [   '  <form class="veritread-form{{extraFormClass}}">',
        ...
        '            <p class="vt-estimator-results-link vt-post-link">',
        '              <a href="https://www.veritread.com/postaload/makeandmodel.aspx?Mode=QP" class="btn btn-secondary" target="_blank">Get Shipping Bids</a>',
        '            </p>',
        '          </div>',
        '        ',
        ...
        '                  <label class="vt-location-header vt-mobile-show">Pickup Location</label>',
        ...
        '              <div class="vt-estimate-parameters">',
        '                  <label class="vt-location-header vt-mobile-show">Delivery Location</label>',
