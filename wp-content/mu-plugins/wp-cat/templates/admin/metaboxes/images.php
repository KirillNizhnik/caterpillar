...
$field  = ( $post->post_type == 'used-equipment' ) ? 'images' : 'additional-images';
...
<div class="cat-admin-bar cat-images-meta">
    ...
    <small>Drag images to reorder.<?php if($post->post_type !== 'used-equipment' ): ?> Feed images do not appear below.<?php endif; ?> Suggested image size: 600px by 400px</small>
</div>
