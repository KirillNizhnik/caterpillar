...
final class CAT
{
    ...
    private function includes()
    {
        ...
        include_once $this->plugin_path . 'includes/core/post-types/abstract-equipment-post-type.php';
        include_once $this->plugin_path . 'includes/core/post-types/new-equipment-custom-post-type.php';
        include_once $this->plugin_path . 'includes/core/post-types/used-equipment-custom-post-type.php';
        include_once $this->plugin_path . 'includes/core/meta-fields/used-equipment-meta-fields.php';
        include_once $this->plugin_path . 'includes/core/meta-fields/new-equipment-meta-fields.php';
        include_once $this->plugin_path . 'includes/core/ajax-rule.php';
    ...
    private function frontend_includes()
    {
        ...
        include_once $this->plugin_path . 'includes/redirection/RedirectionMapper.php';
        include_once $this->plugin_path . 'includes/redirection/redirectors/RedirectorAbstract.php';
        include_once $this->plugin_path . 'includes/redirection/redirectors/NewRedirector.php';
        include_once $this->plugin_path . 'includes/redirection/redirectors/UsedRedirector.php';
        include_once $this->plugin_path . 'includes/redirection/redirectors/NotAvailableUsedRedirector.php';
        include_once $this->plugin_path . 'includes/redirection/redirectors/EquipmentRedirector.php';
    }
    ...
    private function ajax_includes()
    {
        ...
        include_once $this->plugin_path . 'includes/controllers/search.php';
        include_once $this->plugin_path . 'includes/controllers/importers/family-importers/ImporterHandler.php';
        include_once $this->plugin_path . 'includes/controllers/importers/family-importers/new-equipment-family-import.php';
        include_once $this->plugin_path . 'includes/controllers/importers/family-importers/used-equipment-family-import.php';
        include_once $this->plugin_path . 'includes/controllers/importers/mappers/FamilyMapperAbstraction.php';
        include_once $this->plugin_path . 'includes/controllers/importers/mappers/NewEquipmentFamilyMapper.php';
        include_once $this->plugin_path . 'includes/controllers/importers/mappers/UsedEquipmentFamilyMapper.php';
        include_once $this->plugin_path . 'includes/controllers/importers/mappers/FamilyAssignerByRule.php';
        include_once $this->plugin_path . 'includes/controllers/importers/mappers/ajax-for-test-page.php';
    }
    ...
    public function admin_assets($hook)
    {
        ...
        $is_cat = strpos($screen->post_type, 'cat_') === 0
            || $screen->post_type === 'equipment'
            || $screen->post_type === 'used-equipment'
            || strpos($screen->taxonomy, 'cat_') === 0
            || $screen->taxonomy === 'family'
            || $screen->taxonomy === 'used-family'
            || $hook == 'settings_page_cat-settings'
            || $hook == 'tools_page_cat_importer';
